...
--apiserver-advertise-address=172.25.95.4 \
...
sudo mkdir -p /nfs
sudo chown nobody:nogroup /nfs  # 设置权限
sudo chmod 777 /nfs  

cat > /etc/exports <<EOF
/nfs/users *(rw,sync,no_subtree_check,no_root_squash)
/nfs/share *(ro,sync,no_subtree_check,no_root_squash)
EOF
